...
/**
 * This class defines a main in which 1) a tracker is created 2) a Chord network
 * is initialized 3) all the peers in the network are listed 4) a
 * {@link GuideMichelin} is created. It will use the Chord network 5) some data
 * are added to the {@link GuideMichelin} 6) the peers are listed again with the
 * data they store 7) some data are requested from the {@link GuideMichelin}
 */
public class Main {
     ...
     * @throws AlreadyRegisteredException If a peer tries to register more than
     * once
     */
